        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-nowrap" rowspan="2">Penjualan</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @else
                        <th class="text-nowrap text-right">{{ number_format(collect($persen)->where('dokter', $dok->dokter_id)->sum('persen') + collect($persen)->where('dokter', $dok->dokter_id)->sum('biaya'), 2) }}</th>
                    @endif
                    @endforeach
