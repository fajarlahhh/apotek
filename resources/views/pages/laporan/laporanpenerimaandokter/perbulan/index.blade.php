...
@section('title', ' | Penerimaan Dokter Per Bulan')
...
@section('header')
    <h1 class="page-header">Penerimaan Dokter Per Bulan</h1>
@endsection
        ...
        <div class="row width-full">
            <div class="col-xl-3 col-sm-3">
                <div class="form-inline">
                    <a href="/laporanpenerimaandokterbulanan/cetak?bulan={{ $bulan }}&tahun={{ $tahun }}" target="_blank" class="btn btn-warning"> Cetak</a>
                </div>
            </div>
            <div class="col-xl-9 col-sm-9">
                <form id="frm-cari" action="/laporanpenerimaandokterbulanan" method="GET">
...
@else
    <div class="text-center">
        ...
        <small>LAPORAN PENERIMAAN DOKTER BULAN {{ strtoupper(date('M Y', strtotime($tahun."-".$bulan))) }}</small></h3>
    </div>
    <br>
@endif
