...
<div class="modal-footer">
    <form action="/dashboard/lunas" method="POST">
        @csrf
        <input type="hidden" value="{{ $data->first()->barang_masuk_faktur }}" name="faktur">
        <input type="hidden" value="{{ $data->first()->barang_masuk_jatuh_tempo }}" name="tanggal">
