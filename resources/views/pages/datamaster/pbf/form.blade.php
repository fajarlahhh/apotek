...
<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
    ...
    <form action="{{ route('pbf.'.strtolower($aksi)) }}" method="post" data-parsley-validate="true" data-parsley-errors-messages-disabled="">
        @if ($aksi == 'Edit')
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <input type="checkbox" data-render="switchery" data-theme="yellow" value="1" {{ old('konsinyasi') == 1? 'checked': ($aksi == 'Edit' && $data->konsinyasi? 'checked': '') }} data-change="check-switchery-state-text" name="konsinyasi"/>
