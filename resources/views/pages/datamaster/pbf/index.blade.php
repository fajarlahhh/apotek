                ...
                <form id="frm-cari" action="{{ route('pbf') }}" method="GET">
                    <div class="form-inline pull-right">
                        <div class="form-group">
                            <select class="form-control selectpicker cari" name="konsinyasi" data-live-search="true" data-style="btn-success" data-width="100%">
                                <option value="semua" {{ $konsinyasi == 'semua'? 'selected': '' }}>Semua PBF</option>
                                <option value="1" {{ $konsinyasi == '1'? 'selected': '' }}>Konsinyasi</option>
                                <option value="2" {{ $konsinyasi == '2'? 'selected': '' }}>Tidak Konsinyasi</option>
                            </select>
                        </div>&nbsp;
                        <div class="form-group">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle">{{ $row->konsinyasi == 1? "YA": "" }}</td>
                    @role('super-admin|supervisor|user')
